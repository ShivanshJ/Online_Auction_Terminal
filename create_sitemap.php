...
$url = "http://localhost/Auction/"; //The Url of the site - the last '/' is needed

$root_dir = 'C:\xampp\htdocs\Auction'; //Where the root of the site is with relation to this file.
